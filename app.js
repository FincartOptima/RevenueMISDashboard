...
function renderDashboard(){
  ...
  if(rr&&(rr.monthly||rr.ytd)){
    ...
    k.appendChild(kpi(inrCr(rsum('insurance')),'Insurance Revenue','blue'));
    k.appendChild(kpi(inrCr(rsum('fees')),'FEES Revenue','green'));
    k.appendChild(kpi(inrCr(rsum('pms')),'PMS Revenue','violet'));
